...
@section('breadcrumb')
  ...
  <li class="breadcrumb-item active">Data Tier List</li>
@endsection
                      ...
                      <td>
                        <div class="dropdown btn-group dropstart">
                          ...
                          <div class="dropdown-menu dropdown-menu-center">
                            ...
                            ['data' => $company->HashedId]) }}" title="View" class="dropdown-item"><i class="fe-eye"></i> View</a>
